...
const capacityGroups = [
  { title: '01 · SOFTWARE ENGINEERING', what: 'I design and ship full apps: frontend, backend, APIs, databases. I debug them in production.', capacities: ['Full Stack Development', 'Backend Engineering', 'Frontend Engineering', 'API Development', 'Database Engineering', 'Application Architecture', 'Software Integration', 'Software Debugging', 'Systems Design', 'Full Lifecycle Delivery'], where: 'RAG agent, HasteHealth, storefronts, NASA portal', proof: 'Inspect: rag-research-agent · hastehealth-platform · react-storefront' },
  { title: '02 · SYSTEMS & INFRASTRUCTURE', what: 'I run the machines the code lives on: Linux, cloud, deploys. I fix them when they fall over.', capacities: ['Systems Engineering', 'Technical Architecture', 'Linux Systems', 'Cloud Deployment', 'Infrastructure Configuration', 'Networking', 'Service Management', 'System Troubleshooting', 'Deployment Engineering', 'Environment Management', 'Reliability / Failure Diagnosis'], where: 'HasteHealth compose stack, agent harnesses, Linux practice', proof: 'Inspect: hastehealth-platform · agentcore-harness · docker compose' },
