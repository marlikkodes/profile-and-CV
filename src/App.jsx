...
const capacityGroups = [
  ...
  { title: '05 · DATA SYSTEMS', what: 'I model the data first, then build the queries, reports, and apps on top.', capacities: ['Database Systems', 'SQL', 'Data Modelling', 'Data Processing', 'Data Integration', 'Operational Data Systems', 'Reporting Systems', 'Data Driven Applications', 'Information Systems'], where: 'Ecommerce performance analysis, HasteHealth data layer', proof: 'Inspect: ecommerce-performance-dashboard · hastehealth-platform' },
...
const technologyInventory = [
  ...
  { name: 'Solidity', level: 'PRACTICAL', repos: 'contract concepts + wallet flows — not audited production' },
