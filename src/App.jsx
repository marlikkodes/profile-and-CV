...
function CvExperience({ projects, onExplore, onOpenProject }) {
  ...
  return <div className="cv-experience">
    ...
    <nav className="cv-paper-index" aria-label="CV notebook index"><div className="cv-index-tape" aria-hidden="true" /><strong>FIELD INDEX</strong><span>read / inspect / return</span><a href="#cv-about">01 Profile</a><a href="#cv-capacities">02 Capacities</a><a href="#cv-work">03 What I do</a><a href="#cv-projects">04 Selected work</a><a href="#cv-skills">05 Capabilities</a><a href="#cv-approach">06 Approach</a><a href="#cv-evidence">07 Verification</a><a href="#cv-contact">08 Contact</a></nav>
