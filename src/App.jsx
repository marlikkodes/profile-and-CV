...
const capacityGroups = [
  { title: '01 · SOFTWARE ENGINEERING', what: 'I design and ship full apps — frontend, backend, APIs, databases — and I debug them in production.', capacities: ['Full-Stack Development', 'Backend Engineering', 'Frontend Engineering', 'API Development', 'Database Engineering', 'Application Architecture', 'Software Integration', 'Software Debugging', 'Systems Design', 'Full-Lifecycle Delivery'], where: 'RAG agent, HasteHealth, storefronts, NASA portal', proof: 'Inspect: rag-research-agent · hastehealth-platform · react-storefront' },
  { title: '02 · SYSTEMS & INFRASTRUCTURE', what: 'I run the machines the code lives on — Linux, cloud, deploys — and I fix them when they fall over.', capacities: ['Systems Engineering', 'Technical Architecture', 'Linux Systems', 'Cloud Deployment', 'Infrastructure Configuration', 'Networking', 'Service Management', 'System Troubleshooting', 'Deployment Engineering', 'Environment Management', 'Reliability / Failure Diagnosis'], where: 'HasteHealth compose stack, agent harnesses, Linux practice', proof: 'Inspect: hastehealth-platform · agentcore-harness · docker-compose' },
  { title: '03 · AI SYSTEMS', what: 'I make AI do work — agents with memory, tools, and limits — not demos that loop forever.', capacities: ['AI Systems Engineering', 'LLM Application Development', 'SLM Integration', 'AI Agents', 'Agentic Systems', 'Agent Loops', 'AI Memory / State', 'Tool Calling', 'Workflow Orchestration', 'Model Routing', 'Context Engineering', 'Prompt Engineering', 'Custom GPT Systems', 'AI Automation', 'AI-Assisted Development', 'Local AI', 'AI Evaluation', 'AI Research'], where: 'RAG Research Agent, reel-agentic-engineering, agentcore-harness', proof: 'Inspect: rag-research-agent · reel-agentic-engineering · agentcore-harness' },
  { title: '04 · AUTOMATION', what: 'I remove the manual steps — workflows, APIs, messages, data moves — so the work runs itself.', capacities: ['Business Process Automation', 'Workflow Automation', 'API Automation', 'Messaging Automation', 'CRM Automation', 'Sales Automation', 'Procurement Automation', 'AI Automation', 'Data Automation', 'System Integration'], where: 'Agent loops, commerce workflows, messaging experiments', proof: 'Inspect: rag-research-agent · seller-store · signledger' },
  { title: '05 · DATA SYSTEMS', what: 'I model the data first, then build the queries, reports, and apps on top.', capacities: ['Database Systems', 'SQL', 'Data Modelling', 'Data Processing', 'Data Integration', 'Operational Data Systems', 'Reporting Systems', 'Data-Driven Applications', 'Information Systems'], where: 'E-commerce performance analysis, HasteHealth data layer', proof: 'Inspect: ecommerce-performance-dashboard · hastehealth-platform' },
  { title: '06 · BLOCKCHAIN / WEB3', what: 'I build wallet and transaction flows and connect on-chain logic to real products.', capacities: ['Blockchain Development', 'Smart Contract Concepts', 'Solidity (practical, not audited production)', 'EVM Systems', 'Wallet / Transaction Systems', 'Stablecoin Systems', 'On-Chain / Off-Chain Integration', 'Web3 APIs', 'Digital Asset Infrastructure', 'Blockchain Security Basics', 'Web3 Product Development'], where: 'Blockchain Wallet App + transaction artifacts', proof: 'Inspect: blockchain-wallet-app (PHP primary on GitHub)' },
  { title: '07 · SECURITY RESEARCH & ENGINEERING', what: 'I lock things down early — auth, input, secrets — and I investigate when something looks off.', capacities: ['Application Security', 'Authentication', 'Authorization', 'Access Control', 'API Security', 'Input Validation', 'Security Testing', 'System Investigation', 'Linux Security', 'Smart Contract Security Basics', 'Secure System Design'], where: 'Wallet app, platform auth, Linux practice', proof: 'Walkthrough on request — code + records' },
  { title: '08 · BUSINESS TECHNOLOGY', what: "I've worked around real org processes — sales, procurement, messaging — not just code.", capacities: ['CRM Systems', 'Procurement Systems', 'Sales Systems', 'Messaging Systems', 'Operational Workflows', 'Process Digitization', 'Business Systems', 'Internal Tools', 'Client-Facing Systems', 'Technology Operations'], where: 'Org operations work — walkthrough on request', proof: 'Process maps + internal tools — ask for demo' },
  { title: '09 · TECHNICAL LEADERSHIP', what: "I'm not just hands on keyboard — I own decisions and explain them.", capacities: ['Technical Direction', 'System Architecture', 'Technical Decision-Making', 'Project Ownership', 'Technical Strategy', 'Product Engineering', 'Requirements Translation', 'Technical Problem-Solving', 'Cross-Functional Collaboration', 'Team Leadership'], where: 'Founder roles + project ownership across repos', proof: 'Shipped repos + architecture notes' },
  { title: '10 · TECHNICAL ENABLEMENT', what: 'I teach people to use the tools instead of fearing them.', capacities: ['AI Training', 'Technology Training', 'Technical Communication', 'Knowledge Transfer', 'Team AI Adoption', 'Explaining Complex Systems', 'Technical Mentoring'], where: 'Team sessions — materials on request', proof: 'Training notes — ask me' },
]
...
const technologyInventory = [
  ...
  { name: 'Solidity', level: 'EXPOSURE', repos: 'concepts — not audited production' },
...
const systemsBuildable = [
  ...
  { title: 'DATA SYSTEMS', items: ['Operational Databases', 'Reporting', 'Information Systems'] },
  { title: 'INFRASTRUCTURE', items: ['Cloud Apps', 'Linux Systems', 'Deployment Infra', 'Integrations'] },
]

const capabilityAtlas = [
  { title: 'LANGUAGES', items: ['Python', 'JavaScript', 'TypeScript', 'Rust', 'PHP', 'HTML', 'CSS', 'SQL', 'Bash'], evidence: 'Python in RAG agent + signledger, TypeScript in titanstream + agents + seller-store, Rust in HasteHealth, PHP in wallet app, HTML in NASA portal, SQL in ecommerce analysis' },
...
function CvExperience({ projects, onExplore, onOpenProject }) {
  ...
  return <div className="cv-experience">
    ...
    <main className="cv-main">
      <section id="cv-about" className="cv-section cv-intro"><div className="cv-section-label">PROFILE</div><div><h1>I'm Marvin — I build software, AI systems, and infrastructure that actually works.</h1><p>I'm based in Kampala. I do full-stack builds, AI / agents / RAG, APIs and databases, plus Linux, Docker and deployment. If it's complicated, I break it down until it works — and you can check it.</p><div className="cv-focus-line">Software <span>·</span> AI <span>·</span> Infrastructure <span>·</span> Blockchain <span>·</span> Automation</div></div><span className="cv-note">read it first<br />→ then look at the work</span></section>
      ...
      <section id="cv-approach" className="cv-section cv-approach"><div className="cv-section-label">HOW I WORK</div><div><h2>You explain it, I ship the first version.</h2><div className="approach-flow">{['Requirement', 'Constraints', 'Architecture', 'Implementation', 'Integration', 'Testing', 'Deployment', 'Monitoring / Debugging'].map((step, index) => <span key={step}><b>{String(index + 1).padStart(2, '0')}</b>{step}{index < 7 && <i>↓</i>}</span>)}</div></div><p className="cv-approach-note">I start from your problem, sketch the smallest fix that solves it, then stay in the code until it holds.</p></section>
...
function HumanScene() { return <section className="scene-composition human-composition" aria-labelledby="human-title"><div className="human-paper"><p className="scene-kicker">06 / margin note</p><h2 id="human-title">I get restless<br /><em>with black boxes.</em></h2><div className="hand-line" /><h3>So I open them and rebuild.</h3><p className="human-copy">Useful beats clever for me. These notes keep me honest.</p><span className="signature">— Kyemba Marvin</span></div><StickyNote className="human-note-one" label="PERSONAL NOTE" text="Stay curious. Make the complicated useful." /><div className="human-doodle">less theater<br /><span>more signal</span></div></section> }

function ContactScene() { return <section className="scene-composition contact-composition" aria-labelledby="contact-title"><div className="contact-card"><p className="scene-kicker">07 / desk terminal</p><h2 id="contact-title">Let's<br /><em>make it.</em></h2><p>One email is enough to start:</p><a className="drawn-button contact-button" href="mailto:marlikkodes@gmail.com">marlikkodes@gmail.com <span>↗</span></a><div className="contact-line">[ channel open ]</div></div><StickyNote className="contact-note-one" label="NEXT ACTION" text="Send the problem, not the stack." /><div className="desk-terminal"><div>&gt; close_notebook</div><div>&gt; keep_building</div><div className="terminal-answer">done.</div></div></section> }
